...
gdjs.BootCode.asyncCallback9124908 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(5), (runtimeScene) => (gdjs.BootCode.asyncCallback9124908(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.BootCode.asyncCallback9125220 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2.5), (runtimeScene) => (gdjs.BootCode.asyncCallback9125220(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.BootCode.eventsList2(runtimeScene);
